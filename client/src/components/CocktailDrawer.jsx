...
export default function CocktailDrawer({ cocktail, onClose, onOrder }) {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      setIsClosing(false);
      onClose();
    }, 250); // doit correspondre à la durée de l'animation slideOut
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      {/* Drawer principal */}
      <div
        className={`relative bg-white w-full max-h-[90dvh] rounded-t-3xl p-6 pb-8 shadow-lg overflow-y-auto z-50 ${
          isClosing ? "animate-slideOut" : "animate-slideUp"
        }`}
        style={{
          paddingBottom:
            username === "Bloster"
